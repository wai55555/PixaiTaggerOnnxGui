...
class ApiKeyDialog(QDialog):
    ...
    def _build(self, display_name: str, instructions: str) -> None:
        ...
        self.current_label = QLabel(
            self._t("Vlm", "ApiKey_Current_Registered", where=where_label) if registered
    ...
    def _check_and_save(self) -> None:
        ...
        self._check_worker = VlmDiagnosticsWorker(self._conn, key)
    ...
    def _on_check_thread_done(self) -> None:
        ...
        if warn:
            ...
            msg = self._t("Vlm", "ApiKey_Saved_Confirm", where=where)
